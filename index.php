  ...
  <div class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarHeader"></div>
        ...
        <img width="50" height="50" src="https://img.icons8.com/ios/50/shopping-cart--v1.png" alt="shopping-cart--v1"/></i>Carrito <span id="num_cart" class="badge 
          bg-secondary"><?php echo $num_cart; ?></span>
        </a>

        <?php if (isset($_SESSION['user_id'])) { ?>
          <a href="#" class="btn btn-success"><img width="50" height="50" src="https://img.icons8.com/ios/50/user--v1.png" alt="user--v1"/>
        <?php echo $_SESSION
        ['user_name']; ?></a>
          <?php }else{ ?>
              <a href="login.php" class="btn btn-success"><img width="50" height="50" src="https://img.icons8.com/ios/50/user--v1.png" alt="user--v1"/>Ingresar</a>
            <?php } ?>
    </div>
  </div>
</header>
